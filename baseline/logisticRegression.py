...
# Convert hyperedges into a format suitable for CountVectorizer
hyperedges = [line.strip() for line in hyperedges]

# Use CountVectorizer to create a feature matrix
...
param_grid = {
    'C': [0.01, 0.1, 1, 10, 100],
    'penalty': ['l1', 'l2'], 
    'solver': ['liblinear']  # liblinear is chosen to support l1 penalty
}

grid_search = GridSearchCV(LogisticRegression(max_iter=10000, class_weight='balanced'), param_grid, 
